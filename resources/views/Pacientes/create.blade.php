    ...
    <div class="card ">
        <form action="{{ route('pacientes.store') }}" method="POST">
            ...
            <div class="card-header">
                <h5 class="card-title mb-0">Registro del Paciente</h5>
            </div>
            <div class="card-body md-6">
                ...
                <div class="mb-4 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputNombre" name="nombre" value="{{ old('nombre') }}" required>
                    </div>
                </div>
                ...
                <div class="mb-4 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputApellido" name="apellido" value="{{ old('apellido') }}" required>
                    </div>
                </div>
                ...
                <div class="mb-4 row">
                    ...
                    <div class="col-sm-10">
                        <input type="email" class="form-control" id="inputCorreo" name="correo" value="{{ old('correo') }}" required>
                    </div>
                </div>
                ...
                <div class="mb-4 row">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control" id="inputFechaNacimiento" name="fecha_nacimiento" value="{{ old('fecha_nacimiento') }}" required>
                    </div>
                </div>
                ...
                <div class="mb-4 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputDireccion" name="direccion" value="{{ old('direccion') }}">
                    </div>
                </div>
                ...
                <div class="mb-4 row">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" id="inputAntecedentes" name="antecedentes_medicos">{{ old('antecedentes_medicos') }}</textarea>
                    </div>
                </div>
